...
import org.example.repository.UserRepositoryApplication;
...
public class UserRepositoryApplicationIT {
    ...
    public void discoveryServer() throws InterruptedException {
        ...
        ResponseEntity<String> response = new TestRestTemplate().exchange("http://localhost:8081/config-server/eureka/apps", HttpMethod.GET,
                new HttpEntity<>(headers), String.class);
        Assert.assertEquals(HttpStatus.OK, response.getStatusCode());
